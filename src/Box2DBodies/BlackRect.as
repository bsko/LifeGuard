package Box2DBodies 
{
	...
	{
		public static const NAME:String = "BlackRect";
		...
		public function Init(movie:MovieClip, point:Point, isDynamic:Boolean = false, bDensity:Number = 1, bFriction:Number = 0, bRestitution:Number = 0, sensor:Boolean = false, ud:String = null):void
		{
